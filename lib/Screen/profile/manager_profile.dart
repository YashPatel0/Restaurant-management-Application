      ...
      body: Padding(
        ...
        child: StreamBuilder<QuerySnapshot>(
          ...
          builder:
            ...
            final managerData = snapshot.data!.docs.first.data()
            ...
            DocumentSnapshot?
                item; // Define item as a DocumentSnapshot or nullable

// Inside your StreamBuilder builder method or any other appropriate location
            item = snapshot.data!.docs
                .first; // Assuming you're retrieving the first document snapshot

            return Column(
              children: [
                Expanded(
                  child: _buildProfile(managerData , widthFactor),
                ),
                SizedBox(height: 20),
                SizedBox(
  ...
  Widget _buildProfile(Map<String, dynamic> managerData , double widthFactor) {
    // Avoid displaying sensitive information like password
    final name = managerData['name'] ?? 'N/A';
    final phoneNumber = managerData['phone'] ?? 'N/A';
    final address = managerData['address'] ?? 'N/A';
    final aadharNumber = managerData['adhar'] ?? 'N/A';
    final age = managerData['age'] ?? 'N/A';
    final email = managerData['email'] ?? 'N/A';
                        ...
                        onPressed: () {
                          ...
                          FirebaseFirestore.instance
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content:
                                    Text('Failed to update manager: $error'),
